...
{
    public static Vector3 GetNormalWithSphereCast(CharacterController characterController, LayerMask layerMask = default) // Logic for getting the direction at which a hit surface is pointing
    {
